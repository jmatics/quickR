...
Last week my colleague showed me a drawn graph and asked can we plot this kind of graph. It is a graph with grouped boxplot. Additionally, it contains a trend line that connects mean of the each data box. So this post explains how to draw a graph like that using two ways;
...
This data is sample data set from my collegue. The contains NDVI (Normalize Different Vegetation Index) time serise values for three different crops (Maize, Potatoes, Sugar beet) extracted from Landsat 8 data.
